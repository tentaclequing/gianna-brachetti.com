...
def draw_dark_header(c, y):
    ...
    c.drawString(
        LEFT + 14,
        H - 33 * mm,
        "Senior Product Manager  |  AI Products & Search  |  Startup to Scale  |  Multilingual",
    )
    ...
    profile = (
        ...
        "spanning early-stage startups, scale-ups, and enterprise organisations. Native German speaker. "
        "Has managed web platforms with up to 900,000 daily active users. Published multi-level AI "
        "crawler governance with the IAB. Sees teams like an octopus: multiple independent, intelligent "
        "minds that align and grow as one organism. Cross-functional leadership across engineering, "
