...
elsewhere: "Building an open-source prompt and context engineering framework designed to make AI tools accessible to non-technical knowledge workers. Building an [MCP server for Audisto](https://github.com/tentaclequing/audisto-mcp) to integrate crawl data into AI-assisted workflows. Personal connection to healthcare: half my family works in the sector. I have proofread and corrected medical research papers, helped write SOPs for hospitals, and run smaller security tests in my free time. Writing and digital garden at [gianna-brachetti.com](https://gianna-brachetti.com). Volunteer in geriatric psychiatry (2004-2005). Faculty board member, TH Koeln (2011-2012). Former freelance translator (DE/EN/FR/IT)."
---
