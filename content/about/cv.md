...
experience:
  - title: "Senior Product Manager, Search & CMS"
    ...
    location: "Cologne"
    bullets:
      - "Lead a cross-functional team of 7 (engineers, QA, product designer, content strategist) and manage freelancers, owning organic user growth and **search experience** strategy for a high-growth enterprise SaaS product serving **200,000+ business customers** across **100+ languages**. Grew organic traffic by 200% within the first year."
      ...
      - "Own content pipeline for landing pages, comparison pages, funnel pages, and conversion pages. Established cross-functional SEO alignment across the entire company, bringing together engineering, product, and marketing to resolve structural growth blockers."
      ...
      - "Build and maintain measurement and attribution dashboards (SQL, Metabase) to track organic impact on engagement and conversion. Reframed organic growth metrics from traffic share to engagement and conversion. Run **A/B tests** (Statsig) to validate growth hypotheses."
  ...
  - title: "Senior SEO Manager"
    ...
    bullets:
      ...
      - "Fine-tuned and tested the on-site search experience (powered by **Solr**), using search result data, user behaviour signals, and **A/B tests** to improve relevance and discovery."
